...
public class LawDisplayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        laws = new String[]{"General Data Protection Regulation (GDPR)","General Data Protection Regulation (GDPR)","Occupational Safety, Health and Working Conditions Code, 2020","Maintenance and Welfare of Parents and Senior Citizens Act, 2007"};
