...
public class LawsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] laws = new String[]{"General Data Protection Regulation (GDPR)","General Data Protection Regulation (GDPR)","Occupational Safety, Health and Working Conditions Code, 2020","Maintenance and Welfare of Parents and Senior Citizens Act, 2007"};
